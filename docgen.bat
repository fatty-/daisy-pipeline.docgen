...
%JAVA% -classpath %CP%  -Dcom.xmlcalabash.phonehome=false com.xmlcalabash.drivers.Main -c file:///%CONF_DIR:\=/%/calabash-config.xml %MODULE_DIR%\documenter-0.2\document.xpl src=%SRC_DIR:\=/% doc=%OUT_DIR:\=/%
